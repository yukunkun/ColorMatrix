...
public class ClockNormalView1 extends View {
    ...
    public ClockNormalView1(Context context) {
        super(context);
        init(context,null,0);
    }

    public ClockNormalView1(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs,0);
    }

    public ClockNormalView1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawLine(0f, 0f, mWidth, 0f, mHelperPaint);
    ...
    private void drawHour(Canvas canvas, float degrees) {
        mPaint.setTextSize(mHourR * 0.35f);
        //处理整体旋转
        canvas.save();
...
//        if(i==23||i==0||i==24){
//            return mListTime.get(0);
//        }
        return mListTime.get((i+1)/2);
    }
