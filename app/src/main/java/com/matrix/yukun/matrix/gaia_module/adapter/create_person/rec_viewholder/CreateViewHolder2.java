 ...
 */
   public class CreateViewHolder2 extends RecyclerView.ViewHolder{
        ...
        public CreateViewHolder2(View itemView) {
            super(itemView);
            ...
            imageViewL2Map1=(ImageView)itemView.findViewById(R.id.create_lin2_map1);
            imageViewL2Map2=(ImageView)itemView.findViewById(R.id.create_lin2_map2);
