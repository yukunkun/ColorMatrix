 ...
 */
   public class CreateViewHolder3 extends RecyclerView.ViewHolder{
        ...
        public ImageView imageViewL1Map1, imageViewChat,imageViewL2Map1,imageViewL2Map2, imageViewL3Map1,imageViewL3Map2,imageViewL3Map3;
        public LinearLayout layout1,layout2, layout3;
        public CreateViewHolder3(View itemView) {
            super(itemView);
            ...
            imageViewL3Map1=(ImageView)itemView.findViewById(R.id.create_lin3_map1);
            imageViewL3Map2=(ImageView)itemView.findViewById(R.id.create_lin3_map2);
            imageViewL3Map3=(ImageView)itemView.findViewById(R.id.create_lin3_map3);
