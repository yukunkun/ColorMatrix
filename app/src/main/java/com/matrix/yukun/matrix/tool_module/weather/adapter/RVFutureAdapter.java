 ...
 */
public class RVFutureAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<ForecastBase> forecastBeen;

    public RVFutureAdapter(Context context,  List<ForecastBase> forecastBeen) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ForecastBase castBean = forecastBeen.get(position);
