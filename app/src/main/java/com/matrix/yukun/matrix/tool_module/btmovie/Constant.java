...
public class Constant {
    ...
    public static final String BANNER_ADID="4070174244897234";
    public static final String BANNER_NATID="8020376265400916";
    ...
    public static final String BTBTDY="http://m.btbtdy2.net/";
