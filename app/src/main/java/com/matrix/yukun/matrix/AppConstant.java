...
public class AppConstant {
    ...
    public static final String M3U8 = PATH+"/gaia";
    ...
    public static final String GAIAM3U8URL=M3U8+"/gaia.m3u8";
    public static final String SERVICEM3U8URL="/yukun/gaia/gaia.m3u8";
