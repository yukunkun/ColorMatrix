...
class FuncModeToolFragment : Fragment(), EditorModeHandler {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mFuncModePanel = root.findViewById<LinearLayout>(R.id.llFuncMode)
        mFuncDetailsPanel = root.findViewById<FrameLayout>(R.id.flFuncDetails)
        return root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        for (index in modeList.indices) {
            ...
            val ivFuncDesc = item.findViewById<ImageView>(R.id.ivFuncDesc)
